      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm">AI-Driven Smart Hospital & Organ Donation Management System</p>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center">
          <p className="text-gray-400 text-sm">© 2025 MeDiQ Hospital System. Built with Next.js, Agentic AI & Blockchain.</p>
        </div>
      </div>
    </footer>
  )
